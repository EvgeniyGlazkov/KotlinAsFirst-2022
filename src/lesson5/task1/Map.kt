...
//https://kotlinlang.ru/docs/collection-grouping.html
...
//https://kotlinlang.ru/docs/set-operations.html
...
fun findCheapestStuff(stuff: Map<String, Pair<String, Double>>, kind: String): String? {
    ...
    for ((key, value) in stuff) {
        if (value.first == kind) res[value.second] = key
    }
    if (res.isEmpty()) return null
    return res[res.toSortedMap().firstKey()]
}
